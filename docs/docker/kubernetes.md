...
* [一、K8S 简介](kubernetes.md#一k8s-简介)
* [二、K8S 命令](kubernetes.md#二k8s-命令)
* [参考资料](kubernetes.md#参考资料)
...
* **文章**
  * [https://github.com/LeCoupa/awesome-cheatsheets/blob/master/tools/kubernetes.sh](https://github.com/LeCoupa/awesome-cheatsheets/blob/master/tools/kubernetes.sh)
* **更多资源**
