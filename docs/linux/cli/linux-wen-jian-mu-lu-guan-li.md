...
* 切换目录 - 使用 [cd](linux-wen-jian-mu-lu-guan-li.md#cd)
* 查看目录信息 - 使用 [ls](linux-wen-jian-mu-lu-guan-li.md#ls)
* 显示当前目录的绝对路径 - 使用 [pwd](linux-wen-jian-mu-lu-guan-li.md#pwd)
* 树状显示目录的内容 - 使用 [tree](linux-wen-jian-mu-lu-guan-li.md#tree)
* 创建目录 - 使用 [mkdir](linux-wen-jian-mu-lu-guan-li.md#mkdir)
* 删除目录 - 使用 [rmdir](linux-wen-jian-mu-lu-guan-li.md#rmdir)

### 2.2. 文件管理

* 创建空文件 - 使用 [touch](linux-wen-jian-mu-lu-guan-li.md#touch)
* 为文件创建连接 - 使用 [ln](linux-wen-jian-mu-lu-guan-li.md#ln)
* 批量重命名 - 使用 [rename](linux-wen-jian-mu-lu-guan-li.md#rename)
* 显示文件的详细信息 - 使用 [stat](linux-wen-jian-mu-lu-guan-li.md#stat)
* 探测文件类型 - 使用 [file](linux-wen-jian-mu-lu-guan-li.md#file)
* 设置文件或目录的权限 - 使用 [chmod](linux-wen-jian-mu-lu-guan-li.md#chmod)
* 设置文件或目录的拥有者或所属群组 - 使用 [chown](linux-wen-jian-mu-lu-guan-li.md#chown)
* 查找文件或目录 - 使用 [locate](linux-wen-jian-mu-lu-guan-li.md#locate)
* 在指定目录下查找文件 - 使用 [find](linux-wen-jian-mu-lu-guan-li.md#find)
* 查找命令的绝对路径 - 使用 [which](linux-wen-jian-mu-lu-guan-li.md#which)
* 查找命令的程序、源代码等相关文件 - 使用 [whereis](linux-wen-jian-mu-lu-guan-li.md#whereis)

### 2.3. 文件和目录通用管理

* 复制文件或目录 - 使用 [cp](linux-wen-jian-mu-lu-guan-li.md#cp)
* 复制文件或目录到远程服务器 - 使用 [scp](linux-wen-jian-mu-lu-guan-li.md#scp)
* 移动文件或目录 - 使用 [mv](linux-wen-jian-mu-lu-guan-li.md#mv)
* 删除文件或目录 - 使用 [rm](linux-wen-jian-mu-lu-guan-li.md#rm)
...
> cd 命令用来切换工作目录。
>
> 参考：[http://man.linuxde.net/cd](http://man.linuxde.net/cd)
...
> ls 命令用来显示目录信息。
>
> 参考：[http://man.linuxde.net/ls](http://man.linuxde.net/ls)
...
> pwd 命令用来显示当前目录的绝对路径。
>
> 参考：[http://man.linuxde.net/pwd](http://man.linuxde.net/pwd)

### 3.4. mkdir

> mkdir 命令用来创建目录。
>
> 参考：[http://man.linuxde.net/mkdir](http://man.linuxde.net/mkdir)
...
> rmdir 命令用来删除空目录。
>
> 参考：[http://man.linuxde.net/rmdir](http://man.linuxde.net/rmdir)
...
> tree 命令以树状显示目录的内。
>
> 参考：[http://man.linuxde.net/tree](http://man.linuxde.net/tree)
...
>
> 参考：[http://man.linuxde.net/touch](http://man.linuxde.net/touch)
...
>
> 参考：[http://man.linuxde.net/ln](http://man.linuxde.net/ln)
...
>
> 参考：[http://man.linuxde.net/rename](http://man.linuxde.net/rename)
...
>
> 参考：[http://man.linuxde.net/stat](http://man.linuxde.net/stat)
...
>
> 参考：[http://man.linuxde.net/file](http://man.linuxde.net/file)
...
>
> 参考：[http://man.linuxde.net/chmod](http://man.linuxde.net/chmod)
...
>
> 参考：[http://man.linuxde.net/chown](http://man.linuxde.net/chown)
...
>
> 参考：[http://man.linuxde.net/locate\_slocate](http://man.linuxde.net/locate_slocate)
...
>
> 参考：[http://man.linuxde.net/cp](http://man.linuxde.net/cp)
...
>
> 参考：[http://man.linuxde.net/mv](http://man.linuxde.net/mv)
...
>
> 参考：[http://man.linuxde.net/rm](http://man.linuxde.net/rm)
