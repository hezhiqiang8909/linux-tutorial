...
* 压缩和解压 tar 文件 - 使用 [tar](linux-wen-jian-ya-suo-he-jie-ya.md#tar)
* 压缩和解压 gz 文件 - 使用 [gzip](linux-wen-jian-ya-suo-he-jie-ya.md#gzip)
* 压缩和解压 zip 文件 - 分别使用 [zip](linux-wen-jian-ya-suo-he-jie-ya.md#zip)、[unzip](linux-wen-jian-ya-suo-he-jie-ya.md#unzip)
...
>
> 参考：[http://man.linuxde.net/tar](http://man.linuxde.net/tar)
...
>
> 参考：[http://man.linuxde.net/gzip](http://man.linuxde.net/gzip)
...
>
> 参考：[http://man.linuxde.net/zip](http://man.linuxde.net/zip)
...
>
> 参考：[http://man.linuxde.net/unzip](http://man.linuxde.net/unzip)
